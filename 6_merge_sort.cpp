...
// Helper fucntion for printing a vector
...
// Helper fucntion to print out sub-list within original vector
...
void merge(vector<int> &vec, unsigned start, unsigned middle, unsigned end){
	...
	// Clean up remaining lef_hand elements
...
void merge_sort(vector<int> &vec, unsigned l, unsigned r){
	cout<<"Merge Sort ofr L = "<<l<<", R = "<<r<<endl;
